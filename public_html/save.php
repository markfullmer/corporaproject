...
if (isset($_REQUEST['submit'])) {
  ...
  if ($type == 'language') {
    check_permissions($permission = [2]);
  }
  if ($type == 'text') {
    check_permissions($permission = [4]);
  }
  if ($type == 'word') {
    check_permissions($permission = [5]);
  }
  if ($type == 'pos') {
    check_permissions($permission = [6]);
  }
  if ($type == 'article') {
    check_permissions($permission = [7]);
  }
  if ($type == 'meta') {
    check_permissions($permission = [8, 9, 10]);
  }
  if ($type == 'genre') {
    check_permissions($permission = [11]);
  }
  if ($type == 'domain') {
    check_permissions($permission = [12]);
  }
  if ($type == 'meta' && $id == 'add') {
  ...
  if (isset($_REQUEST['name'])) {
    $name = ucwords(strtolower((string) $_REQUEST['name']));
  }
  ...
  if (isset($_REQUEST['author'])) {
    $author = ucwords(strtolower((string) $_REQUEST['author']));
  }
  ...
  if (isset($_REQUEST['frequent_word_value'])) {
    $frequent_word_value = $_REQUEST['frequent_word_value'];
  }
  if (isset($_REQUEST['sentences_constant'])) {
    $sentences_constant = $_REQUEST['sentences_constant'];
  }
  if (isset($_REQUEST['words_constant'])) {
    $words_constant = $_REQUEST['words_constant'];
  }
  ...
  if (isset($_REQUEST['words_to_display'])) {
    $words_to_display = $_REQUEST['words_to_display'];
  }
  if (isset($_REQUEST['texts_to_display'])) {
    $texts_to_display = $_REQUEST['texts_to_display'];
  }
  if (isset($_REQUEST['search_results'])) {
    $search_results = $_REQUEST['search_results'];
  }
  ...
  if (isset($_REQUEST['sample_sentence'])) {
    $sample_sentence = $_REQUEST['sample_sentence'];
  }
  if (isset($_REQUEST['english_equivalent'])) {
    $english_equivalent = $_REQUEST['english_equivalent'];
  }
  ...
  if (isset($_REQUEST['standard_spelling'])) {
    $standard_spelling = $_REQUEST['standard_spelling'];
  }
  if (isset($_REQUEST['referrer'])) {
    $referrer = $_REQUEST['referrer'];
  }
  if (isset($_REQUEST['englishword'])) {
    $englishword = $_REQUEST['englishword'];
  }
  else {
    $englishword = 0;
  }
  ...
  if ($type == 'article') {
    if ($_REQUEST['submit'] == 'Add') {
      $id = insert_article($name, $content, $db);
    }
    if ($_REQUEST['submit'] == 'Update') {
      update_article($id, $name, $content, $db);
    }
  ...
  if ($type == 'text') {
    ...
    if (str_word_count((string) $content) > '100000') {
      header('Location: ./edit.php?type=text&id=add&message=1');
    }
    else {
  ...
  if ($type == 'user') {
    ...
    if ($_POST['password'] == '') {
      ...
      $password = hash('ripemd160', (string) $_POST['password']);
    }
    if ($id == 'add') {
